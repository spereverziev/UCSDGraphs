...
public abstract class Graph {
    ...
    public List<Integer> degreeSequence() {
        ...
        for(int i = 0; i < numVertices; i++) {
            List<Integer> inDegree = getNeighbors(i);
            List<Integer> outDegree = getInNeighbors(i);

            degreeSequence.add(inDegree.size() + outDegree.size());
        }
        Collections.sort(degreeSequence, Comparator.reverseOrder());
